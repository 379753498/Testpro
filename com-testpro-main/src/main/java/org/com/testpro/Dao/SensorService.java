...
import org.com.testpro.DaoMapper.SensorData13;
import org.com.testpro.DaoMapper.SensorData15;
...
public class SensorService {
	 ...
	 * @Description:
	 */
	@ChooseDataSource(dataSourceName =DataEnum.DATA_SOURCE_FROM_13)
	...
	@ChooseDataSource
	public List<SensorData> getbridgenameinfo()
	{
		
		String sql = "select  distinct a.equipmentname,a.parent_id,b.tid,b.monitor_id,c.bridgename,d.tname,b.sensor_code from  PLAT_BAS_EQUIPMENT a,PLAT_BAS_EQUIPCONFIG b,PLAT_BAS_BRIDGE c,plat_bas_dictionary d where a.equipmentid=b.equip_id and c.bridgeid=b.build_id and d.tid=b.monitor_id and b.sensor_code is not null and d.tname!='地磅' ";
		List<SensorData> queryForList = jdbcTemplate.query(sql,new SensorData15());
		return queryForList;
